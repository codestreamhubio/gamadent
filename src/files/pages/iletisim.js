  ...
  return (
    <div className={'mt-[120px]'}>
      <div className={'flex flex-col justify-center items-center'}>
        <h2 className={'font1 text-5xl'}>Contact Us</h2>
        <h2
          className={
          ...
          >
            ...
            <div className={'flex justify-center flex-col'}>
              ...
              <h2 className={'font4 text-text2 w-[200px] sm:w-[300px]'}>
                Monday - Saturday (9:00am - 18:00pm) Market (Closed)
              </h2>
            </div>
          </div>
          <a
            target={'_blank'}
            href={`mailto:info@Gamadent.com`}
            className={
        ...
        >
          <div className={'flex flex-col w-full sm:flex-row gap-[32px]'}>
            <div className={'flex flex-col gap-[10px]'}>
              <h4 className={'flex flex-col font21 text-text2'}>First Name</h4>
              <div
                className={
            ...
            <div className={'flex w-full flex-col gap-[10px]'}>
              <h4 className={'flex flex-col font21 text-text2'}>Last Name</h4>
              <div
                className={
          ...
          <div className={'mt-[20px]'}>
            <div className={'flex flex-col gap-[10px]'}>
              <h4 className={'flex flex-col font21 text-text2'}>Email</h4>
              <div
                className={
          ...
          <div className={'mt-[20px]'}>
            <div className={'flex flex-col gap-[10px]'}>
              <h4 className={'flex flex-col font21 text-text2'}>Select Date</h4>
              <div
                className={
          ...
          <div className={'mt-[20px] h-full w-full'}>
            <div className={'flex w-full h-full flex-col gap-[10px]'}>
              <h4 className={'flex flex-col font21 text-text2'}>Message</h4>
