    ...
    <div className={'w-full h-full'}>
      <div className={'mt-[140px]'}>
        ...
        >
          <div
            className={
              ' w-fit rounded-lg grid md:grid-row grid-cols2 md:grid-cols-3 flex-col px-[35px]  py-[50px] gap-[30px] justify-center items-center h-fit lg:h-fit'
            }
          >
            <div
              className={
            ...
            >
              ...
              <h1
                className={
                  'font4 px-4 text-text2 px-4 md:h-[170px] lg:h-32 2xl:text-lg text-base text-center '
                }
              >
                It's never been easier to brighten your smile at home. There are
                all kinds of products you can try.{' '}
              </h1>
              <div
                className={
                  'flex  md:flex-col lg:flex-row gap-[12px] justify-center items-center pb-6'
            ...
            >
              ...
              >
                Preventive dentistry is dental care that helps maintain good
                oral health. a combination of regular dental.{' '}
              </h1>
              <div
                className={
                  'flex  md:flex-col lg:flex-row gap-[12px] justify-center items-center pb-6'
      ...
      <div className={'mt-[120px]'}>
        <div
          className={
            'w-full h-fit bg-bg5 md:p-16 p-16 lg:p-10 xl:gap-[60px] sm:p-16  flex justify-center items-center md:flex-col lg:flex-row flex-col'
          }
        >
          <div
            className={
          ...
          >
            ...
            <h2
              className={
                'font3 text-xl text-white w-[330px] lg:w-[450px] sm:w-[400px] md:w-[400px] xl:w-[550px] mt-[45px]  '
              }
            >
              We use only the best quality materials on the market in order to
          ...
          <div
            className={
              'xl:w-[400px] lg:m-0 mt-12 lg:w-[350px] pb-8 bg-white rounded-[30px] flex-col flex justify-start pt-[34px] px-[30px]'
            }
          >
            <h2 className={'font1 text-2xl'}>Create Appointment Request</h2>
            <div
              className={
                'mt-[39px] sm:text-base text-sm w-full flex flex-col gap-[20px]'
              }
            >
              ...
              <div className={'w-full h-fit bg10 flex'}>
                <h2 className={'px-[20px] py-[14px] text-text4'}>
                  <input
                    className={'w-full h-full border-none outline-none'}
                    placeholder={'The Treatment You Want to Receive'}
                    type="text"
                  />
                </h2>
              </div>
              <div className={'flex justify-end w-full'}>
                <div
                  className={
                    'bg-bg2 hover:bg-bg7 cursor-pointer cursor-pointer md:w-full w-full lg:w-[120px] md:h-[55px] md:mt-2 lg:h-[35px] px-[15px] flex justify-center items-center py-[20px] rounded-lg'
                  }
                >
      ...
      <div className={'mt-[100px] flex justify-center items-center'}>
        <div
          className={
            'w-full sm:h-[700px] bg5 flex justify-start items-center pt-[60px] flex-col'
          }
        >
          <div className={'flex justify-center items-center flex-col'}>
            ...
            <div className={'mt-[80px]'}>
              <div className={'flex justify-center items-center w-full'}>
                <div
                  className={
                    'flex flex-row justify-center items-center gap-[20px] xl:w-[1100px] lg:w-[900px] md:w-[700px] w-[350px] 2xl:w-[1440px]'
                  }
                >
                  <Swiper
                    spaceBetween={60}
                  ...
                  >
                    <SwiperSlide>
                      <div className={'relative flex sm:ml-0 ml-6'}>
                        ...
                        <div
                          className={
                            'absolute flex flex-col bg6 overflow-hidden  lg:h-[50px] lg:w-[170px] md:h-[80px] md:w-[270px] h-[80px] w-[270px] xl:w-[12rem] 2xl:w-[16rem] pl-5 py-1 xl:h-[4rem] 2xl:h-[5rem] bottom-[16px] left-[16px]'
                          }
                        >
                          <h2
                            className={
                    ...
                    <SwiperSlide>
                      <div className={'relative w-full '}>
                        <img className={''} src={docphoto2} alt="" />
                        <div
                          className={
                    ...
                    <SwiperSlide>
                      <div className={'relative w-full '}>
                        <img className={''} src={docphoto3} alt="" />
                        <div
                          className={
                            'absolute  flex flex-col bg6  lg:h-[50px] lg:w-[170px] md:h-[80px] md:w-[270px] h-[80px] w-[270px] xl:w-[12rem] 2xl:w-[16rem] pl-5 py-1 xl:h-[4rem] 2xl:h-[5rem] bottom-[16px] left-[16px]'
                          }
                    ...
                    <SwiperSlide>
                      <div className={'relative w-full '}>
                        <img className={''} src={docphoto4} alt="" />
                        <div
                          className={
                            'absolute  flex flex-col bg6  lg:h-[50px] lg:w-[170px] md:h-[80px] md:w-[270px] h-[80px] w-[270px] xl:w-[12rem] 2xl:w-[16rem] pl-5 py-1 xl:h-[4rem] 2xl:h-[5rem] bottom-[16px] left-[16px]'
                          }
                    ...
                    <SwiperSlide>
                      <div className={'relative w-full '}>
                        <img className={''} src={docphoto5} alt="" />
                        <div
                          className={
                            'absolute  flex flex-col bg6  lg:h-[50px] lg:w-[170px] md:h-[80px] md:w-[270px] h-[80px] w-[270px] xl:w-[12rem] 2xl:w-[16rem] pl-5 py-1 xl:h-[4rem] 2xl:h-[5rem] bottom-[16px] left-[16px]'
                          }
      ...
      <div className={'mt-[90px] flex justify-center items-center'}>
        <div
          className={
            'lg:w-[900px] md:w-[700px] w-[350px] xl:w-[1064px] h-fit pb-10 md:h-[392px] bg-[#374857] rounded-[30px]  xl:gap-[50px] flex justify-center items-center flex-col md:flex-row'
          }
        >
          <div
            className={
          ...
          >
            ...
            <div
              ...
              className={
                'bg-bg2 hover:bg-bg7 cursor-pointer w-[200px] h-[50px] cursor-pointer mt-[20px] md:mt-[40px] px-[0px] flex justify-center items-center py-[20px] rounded-lg'
              }
            >
              <h2 className={'text-white font2 text-[16px] w-fit'}>
                Contact Information
              </h2>
            </div>
          </div>
