    ...
    <div className={'text-7xl w-full h-full flex flex-col gap-[120px]'}>
      ...
      >
        ...
        >
          ...
          >
            <span className={''}>Gentle Physicians</span>
            <span>Fast And Effective Results!</span>
          </h2>
          <div
            className={
          ...
          <div
            className={
              'flex md:flex-col flex-col lg:flex-row gap-[24px] justify-start items-center mt-[20px]'
            }
          >
            <div
              onClick={() => {
          ...
          <div
            className={
              'xl:w-[374px] sm:w-[430px] lg:w-[300px] w-[330px] h-[200px] md:w-[374px] sm:h-[170px] xl:h-[125px] md:h-[115px] lg:h-[115px] relative gap-[8px] p-[20px] md:mt-[40px] lg:mt-[60px]  flex justify-start items-start flex-col bg2'
            }
          >
            <div className={'flex flex-row gap-2 cursor-pointer'}>
              <img
                className={
                  'xl:w-[41px] w-[65px] h-[65px] lg:w-[30px] md:w-[35px] md:h-[35px] lg:h-[30px] xl:h-[41px]'
                }
                src={ornekfoto}
                alt=""
              />
              <div className={'flex flex-col justify-center'}>
                <h1
                  className={
                    'xl:text-[16px] text-[20px] lg:text-[13px] md:text-[13px] leading-4 font2'
                  }
                >
                  Example Name
                </h1>
                <h2
                  className={
                    'xl:text-[16px] text-[16px] lg:text-[10px] md:text-[10px] leading-6 font4'
                  }
                >
                  Specialist Dr...
                </h2>
            ...
            <img
              className={'top-5 w-[70px] md:w-fit  right-5 absolute'}
              src={plusone}
              alt=""
            />
          </div>
      ...
      <div className={'mt-[120px] flex justify-center items-center'}>
        ...
        >
          <img
            className={
              'md:pl-[80px] 2xl:w-full xl:h-auto xl:w-[500px] lg:w-[450px]  md:w-[350px] md:h-[300px] lg:h-[370px] w-[200px]'
            }
            src={Rectangle631}
            alt=""
          />
          ...
          >
            ...
            >
              ...
              <div className={'flex flex-row items-center gap-2'}>
                <img className={'lg:w-7 xl:w-8'} src={shieldicon} alt="" />
                <h3 className={'font2'}>
                  Competitive Prices for All Our Treatments
                </h3>
              </div>
              <div className={'flex flex-row items-center gap-2'}>
                <img className={'lg:w-7 xl:w-8'} src={shieldicon} alt="" />
      ...
      <div className={' flex justify-center items-center'}>
        ...
        >
          <div className={'flex justify-center items-center flex-col'}>
                  ...
                  >
                    <SwiperSlide>
                      ...
                      >
                        ...
                        >
                          Phosfluorescently synergize covalent outsourcing
                          through functional strategic theme areas. Assertively
                          scale strategic portals without distinctive
                          relationships. Holisticly cultivate tactical
                          e-services before fully researched sources.
                        </h3>
                      </div>
                    </SwiperSlide>
                    <SwiperSlide>
            ...
            <div
              className={'mt-[140px] w-full h-full justify-center items-center'}
            >
              <div
                className={
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      className={
                        'w-full h-fit flex justify-center items-center'
                      }
                    >
                    ...
                    >
                      <h2 className={'text-white font4 text-base'}>
                        Kategori 1
                      </h2>
                    </div>
                    ...
                    <h3
                      className={
                        'text-text2 mt-[10px] text-lg xl:text-xl w-[250px]'
                      }
                    >
                ...
                >
                  ...
                  >
                    <h2 className={'text-white font2 text-base'}>
                      Check out more
                    </h2>
                  </div>
                </div>
