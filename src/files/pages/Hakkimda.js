      ...
      <div className={'w-[1440px] h-full'}>
        ...
        >
          <div className={'flex flex-col '}>
            ...
            >
              Lorem ipsum dolor sit amet consectetur. Vel aliquam velit nisi
              posuere etiam porttitor nulla. Enim amet facilisis facilisis
              ornare odio. Consectetur lectus purus sem sit quis. Habitant
              mauris interdum tellus massa dictum nunc. Volutpat blandit neque
              pharetra sagittis urna convallis eget. Elementum commodo nisl quam
              diam. Diam mi sagittis faucibus mollis nulla sit pretium nunc
              lectus. Porttitor interdum aliquam egestas interdum nascetur
              praesent.
            </h2>
            <h2
              className={
            ...
            >
              Lorem ipsum dolor sit amet consectetur. Eleifend purus a sed
              pretium id non. Tellus luctus amet volutpat in. Turpis facilisi
              purus tincidunt turpis nunc egestas. Consectetur sed eu fames
              facilisis vestibulum risus egestas. Sed duis eget blandit commodo
              dictumst aliquet. Quam euismod donec viverra odio eget risus diam
              commodo nibh. Vitae hendrerit augue tristique viverra dui amet
              malesuada. Elementum cursus mi et luctus a faucibus venenatis ac
              non. Eu tortor sollicitudin orci parturient sit cursus nunc at.
              Velit rhoncus felis lectus tortor.
            </h2>
          </div>
          <img
            className={'xl:w-[453px] md:w-[300px] w-[300px]'}
            src={aboutdoc1}
            alt=""
          />
        </div>
        <div className={'mt-[120px] flex flex-col justify-center items-center'}>
          ...
          >
            ...
            >
              <img
                className={'md:w-[600px] lg:w-[306px]'}
                src={uzmanlar1}
                alt=""
              />
              <div
              ...
              >
                <div
                  className={
                    'flex sm:flex-row flex-col gap-[16px] items-center'
                  }
                >
                  <h2 className={'font6 !2xl:text-xl text-2xl md:text-4xl'}>
                    Prof.Dr. Name Surname
                  </h2>
                  <h3 className={'font4 2xl:text-sm text-base md:text-2xl'}>
                    (General & Cosmetic Service Specialization)
                  </h3>
                </div>
                <div
                  className={
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  className={
                    'bg-bg2 hover:bg-bg6 w-fit mt-[35px] h-[35px] sm:p-[40px] p-[25px] lg:p-[25px] flex justify-center items-center rounded-md cursor-pointer cursor-pointer'
                  }
                >
                  <h2 className={'text-white font9 sm:text-3xl lg:text-lg'}>
                    Make an Appointment
          ...
          >
            ...
            >
              <img
                className={'w-[310px] md:w-full'}
                src={teknelojifoto}
                alt=""
              />
              <div className={'flex flex-col justify-start items-center'}>
                <div
                  className={'sm:w-fit w-[310px] text-center  text-xl font2'}
                >
                ...
                >
                  ...
                  <h2>
                    ...
                    become the standard of dental care. Using an intraoral
                    scanner with digitized data for 3D dental impressions (vs.
                    polyvinyl siloxane and rubber base impressions) for a dental
                    crown is now commonplace.
                  </h2>
                  <h2>
                    Artificial intelligence is laying the groundwork for the
                    future of the dental industry. Dental robots can now perform
                    functions such as filling cavities and cleaning or
                    extracting teeth
                  </h2>
                </h2>
              </div>
        ...
        <div className={'mt-[120px]'}>
          <div className={'flex justify-center items-center '}>
            <div
              className={
                'bg-text2 w-fit px-[5vw] rounded-lg flex md:flex-row flex-col   py-[50px] gap-[30px] justify-center items-center md:h-[550px] lg:h-[450px]'
              }
            >
              <div
                className={
        ...
        <div className={'mt-[120px]'}>
          <div className={'flex flex-col justify-center items-center'}>
            <h2
              className={
                'font1 text-3xl sm:text-5xl w-[350px] sm:w-[500px] text-center'
              }
            >
