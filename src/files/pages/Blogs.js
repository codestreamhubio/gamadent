    ...
    <div className={''}>
      <div className={'mt-[140px]'}>
        <div className={'flex flex-col justify-center items-center'}>
          <h2
            className={
              'font1 xl:text-5xl lg:text-4xl md:text-3xl text-3xl 2xl:text-6xl'
            }
          >
            Blogs
          </h2>
          <h2
            className={
              'font4 text-sm sm:text-lg md:text-xl sm:w-[450px] w-[250px] md:w-[515px] items-center text-center mt-[20px] text-text2 '
            }
          >
          ...
          <div
            className={
              'w-[250px] sm:w-[450px] md:w-[515px] xl:w-[500px] h-[55px] bg11 mt-[40px] flex flex-row pl-[20px] py-[12px]'
            }
          >
            <img className={'w-[24px] h-[24px]'} src={searchimg} alt="" />
            <h1 className={'font7 text-text3 pl-[8px]'}>
              <input
                className={'w-full h-full font7 border-none outline-none'}
                placeholder={'Bloglarda Arat'}
                type="text"
              />
            </h1>
          </div>
        ...
        <div className={'flex justify-center items-center mt-[10px]'}>
          <div
            className={
              'flex flex-row gap-[20px] 2xl:w-[1440px] lg:w-[1000px] md:w-[700px] w-[330px] sm:w-[600px] xl:w-[1240px]'
            }
          >
            <Swiper
              spaceBetween={50}
              ...
              <SwiperSlide>
                <div className={'relative w-full'}>
                  <div className={'flex justify-center items-center mt-[50px]'}>
                    <div
                      className={
                        'p-[20px] pb-[40px] bg12 relative cursor-pointer'
                      }
                    >
                      <img
                        className={'w-[370px] h-[290px]'}
                        src={blogfoto1}
                        alt=""
                      />
                      <div className={'pl-4 '}>
                        <div
                          className={
                            'w-full h-full mt-[27px] flex justify-between items-center'
                          }
                        >
                          <div
                            className={
                              'bg-bg2 w-fit h-[35px] px-[20px] flex justify-center items-center py-5 rounded-md'
                            }
                          >
                            <h2
                              className={
                                'text-white font9 whitespace-nowrap text-lg'
                              }
                            >
                              Kategori 1
                            </h2>
                          ...
                          <h4
                            className={
                              'text-center pr-4 flex justify-center items-center'
                            }
                          >
                            ~Yazar Adı Soyadı
                          </h4>
                        ...
                        <h3
                          className={'text-text2 mt-[10px] text-xl break-words'}
                        >
                      ...
                      <div className={'pl-4 '}>
                        ...
                        >
                          ...
                          >
                            <h2
                              className={
                                'text-white whitespace-nowrap font9 text-lg'
                              }
                            >
                              Kategori 2
                            </h2>
                    ...
                    >
                      ...
                      <div className={'pl-4 '}>
                        ...
                        >
                          ...
                          >
                            <h2 className={'text-white font9 text-lg'}>
                              Kategori 1
                            </h2>
                          </div>
                          <h4
